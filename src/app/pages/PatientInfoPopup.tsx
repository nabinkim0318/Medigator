...
const PatientInfoPopup: React.FC<PatientInfoPopupProps> = ({ isOpen, onClose, patient }) => {
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', height: 'calc(90vh - 100px)', overflow: 'hidden' }}>
          {/* Left Column */}
          <div style={{ width: '300px', padding: '32px', borderRight: '1px solid #e5e7eb', overflow: 'auto' }}>
            {/* Patient Header */}
            <div style={{ marginBottom: '32px' }}>
              <h3 style={{ fontSize: '20px', fontWeight: '600', color: '#1f2937', margin: '0 0 4px 0' }}>
                {patientData.name}
              </h3>
              <p style={{ color: '#6b7280', fontSize: '14px', margin: '0 0 16px 0' }}>MRN: {patientData.mrn}</p>

              <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '16px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <Clock style={{ width: '16px', height: '16px', color: '#6b7280' }} />
                  <span style={{ fontSize: '12px', color: '#6b7280' }}>Last Appointment</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                  <User style={{ width: '16px', height: '16px', color: '#6b7280' }} />
                  <span style={{ fontSize: '12px', color: '#6b7280' }}>Age & Gender</span>
                </div>
              </div>
            ...
            <InfoSection title="Patient Data">
              ...
              <DataRow label="Blood Pressure (BP)" value={patientData.bloodPressure} />
              <DataRow label="Temperature" value={patientData.temperature} />
              <DataRow label="Oxygen Saturation" value={patientData.oxygenSaturation} />
            </InfoSection>
          </div>
          ...
          <div style={{ flex: 1, padding: '32px', overflow: 'auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', marginBottom: '32px' }}>
              <div style={{ backgroundColor: '#fefce8', border: '1px solid #fde047', borderRadius: '12px', padding: '20px' }}>
                <h4 style={{ color: '#f59e0b', fontSize: '14px', fontWeight: '600', margin: '0 0 12px 0' }}>
                  HPI
                </h4>
                <ul style={{ margin: 0, paddingLeft: '16px' }}>
                  {hpiSymptoms.map((symptom, index) => (
                    <li key={index} style={{ fontSize: '14px', color: '#1f2937', marginBottom: '8px' }}>
                      {symptom}
                    </li>
                  ))}
                </ul>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px', marginBottom: '32px' }}>
              <div>
                ...
                <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>{medicalHistory[0]}</p>
              </div>
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>{dangerousSymptoms}</p>
              </div>
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>{painScale}</p>
              </div>
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>{recentTravel}</p>
              </div>
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>{smokingAlcohol}</p>
              </div>
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>{medications}</p>
              </div>
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>Not applicable</p>
              </div>
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>{allergies}</p>
              </div>
              ...
              <div>
                ...
                <p style={{ fontSize: '14px', color: '#6b7280', margin: 0 }}>{familyHistory}</p>
              </div>
            </div>
          ...
          {/* Right Column */}
          <div style={{ width: '350px', padding: '32px', borderLeft: '1px solid #e5e7eb', overflow: 'auto' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {recommendedResearch.map((item, index) => (
                  ...
                  >
                    ...
                    />
                    <div style={{ flex: 1 }}>
                      <h5 style={{ fontSize: '14px', fontWeight: '600', color: '#1f2937', margin: '0 0 4px 0' }}>
                        {item.title}
                      </h5>
                      <p style={{ fontSize: '12px', color: '#6b7280', margin: '0 0 8px 0' }}>{item.subtitle}</p>
                      <span
                        style={{
                          fontSize: '10px',
                          fontWeight: '600',
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {similarPatients.map((sp, index) => (
                  <div key={index} style={{ padding: '16px', backgroundColor: '#f9fafb', borderRadius: '8px' }}>
                    ...
                    <p style={{ fontSize: '13px', fontWeight: '500', color: '#1f2937', margin: '0 0 8px 0' }}>
                      {sp.condition}
                    </p>
                    <p style={{ fontSize: '12px', color: '#6b7280', margin: '0 0 12px 0' }}>{sp.details}</p>
                    <span
                      style={{
                        fontSize: '11px',
                        fontWeight: '600',
                        color: 'white',
                        backgroundColor: sp.status === 'Correct Diag' ? '#10b981' : '#f59e0b',
                        padding: '4px 8px',
                        borderRadius: '4px',
                      }}
                    >
